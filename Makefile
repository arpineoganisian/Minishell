...
SRCS_LIST	= main.c parser.c exec_commands.c syntax_handler.c spec_sym_handler.c split_by_pipe.c parser_utils.c \
			...
			strings_counter.c execute_bin.c find_env_var.c join_str_to_arr.c get_minishell_env.c signals.c \
			redirect_handler_utils.c redirect_handler_utils_2.c envp_utils.c str_3_join.c
